...
function useMailStore() {
    ...
    async function sendMail(params: ISendMailParams) {
    ...
    async function sendOTP(params: ISendOTPParams) {
        ...
        const otp = await otpStore.getNewOTP(params.emailTo);
